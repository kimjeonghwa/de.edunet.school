...
$string['privacy:metadata'] = 'The Edunet theme does not store any personal data about any user.';
...
$string['privacy:metadata:preference:themeEdunetsettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themeEdunetsettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
